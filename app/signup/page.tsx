    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8F9FA] px-4">
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-10 text-center max-w-md w-full"
          ...
          <Link href="/login" className="mt-6 inline-block text-sm text-[#E8315A] hover:underline font-semibold">
            Back to Sign In
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8F9FA] px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-[#0F172A] mt-6">Create your account</h1>
          <p className="text-sm text-[#64748B] mt-1">Join thousands of fans on TicketMint</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-8 space-y-4"
          ...
          <p className="text-xs text-center text-[#94A3B8]">
            ...
            <a href="/guarantee" className="text-[#E8315A] hover:underline">Terms of Service</a>.
          </p>
          <p className="text-center text-sm text-[#64748B]">
            Already have an account?{" "}
            <Link href="/login" className="text-[#E8315A] font-semibold hover:underline">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
